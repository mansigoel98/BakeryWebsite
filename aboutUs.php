...
.imgs1{
  ...
  border: 5px solid rgb(201, 235, 150);
}
.imgs2{
...
<section class="div2">
    <h1 class="annh">About Us</h1>
    <h3 style="text-align: center"><u>Our Company</u></h3>
    <p style="text-align: center">When we inaugurated our bakery for the first time in our very own city Indore, 
      in 1985, people did not have any 
      understanding for cheese, cream cakes, pizza, burgers etc. but we took the liability to pioneer 
      this fresh food into the town, which turned out to be a great accomplishment, which had not been achievable 
      devoid of you people’s love and loyalty toward us.<br><br>

        This website has been shaped so that we people can order cakes for 
        their loved ones. You can share your incredibly valuable views on our bakery, and any kind of suggestions
         would be highly appreciated.</p>
         <br>
         <h3 style="text-align: center"><u>OUR 25 YEARS JOURNEY</u></h3>
         <hr style="color: grey ; border-style: dashed;border-width: medium">
         <div>
           <a href="https://www.youtube.com/watch?v=kDPgq2OTBv0"><img src="video1.jpg" alt="video" class="imgs1"></a>
           <a href="https://www.youtube.com/watch?v=gNyFTuQtkZE"><img src="video2.jpg" alt="video" class="imgs2"></a>
         </div>

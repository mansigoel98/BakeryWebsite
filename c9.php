...
<div class="img-zoom-container">
  <img id="myimage" src="sacke9.jpg" width="300" height="300" style="border: 5px solid white">
</div>
<div class="desc">
  <div style="border-bottom: 2px dotted green">
<h1 class="annh">Strawberry Chochlate Cake</h1>
<p style="text-align: center; font-size:15px; margin:15px">Strawberry Chochlate cake

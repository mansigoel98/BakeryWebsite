...
<div class="img-zoom-container">
  <img id="myimage" src="cj4.jpg" width="300" height="250" style="border: 3px solid white">
 
</div>
<div class="desc">
  <div style="border-bottom: 2px dotted green">
<h1 class="annh">Brownie Cake Jar</h1>
  </div>
  <div>
     <p style="color: brown; font-style: italic; margin-top: 40px; margin-left: 20px;margin-right: 20px;margin-bottom:40px;font-size: 20px; text-align: left;">Price: Rs 675.00
  ...
  <div>
    <?php
    $_SESSION['cakeName']="Brownie Cake Jar";
    $_SESSION['price']="675.00";
    $_SESSION['imgcake']="cj4.jpg";
    $_SESSION['type']="cake";

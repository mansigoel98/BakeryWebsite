...
<div class="img-zoom-container">
  <img id="myimage" src="sacke7.jpg" width="300" height="300" style="border: 5px solid white">
</div>
<div class="desc">
  <div style="border-bottom: 2px dotted green">
<h1 class="annh">Dark Chochlate Cake</h1>
<p style="text-align: center; font-size:15px; margin:15px">Dark Chochlate cake
  For all the Choclate lovers!! Dark Chochlate chunks with a sophisticated design.</p>
  </div>
  <div>
     <p style="color: brown; font-style: italic; margin-top: 40px; margin-left: 20px;margin-right: 20px;margin-bottom:40px;font-size: 20px; text-align: left;">Price: Rs 1075.00
  ...
  <div>
    ...
    $_SESSION['price']="1075.00";
    $_SESSION['imgcake']="sacke7.jpg";
    $_SESSION['type']="cake";

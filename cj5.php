...
<div class="img-zoom-container">
  <img id="myimage" src="cj5.jpg" width="300" height="250" style="border: 3px solid white">
...
<h1 class="annh"> Flower Cake</h1>
  ...
  <div>
     <p style="color: brown; font-style: italic; margin-top: 40px; margin-left: 20px;margin-right: 20px;margin-bottom:40px;font-size: 20px; text-align: left;">Price: Rs 875.00
  ...
  <div>
    <?php
    $_SESSION['cakeName']="Flower Jar";
    $_SESSION['price']="875.00";
    $_SESSION['imgcake']="cj5.jpg";
    $_SESSION['type']="cake";

...
<div class="img-zoom-container">
  <img id="myimage" src="bdcake7.jpg" width="300px" height="300px" style="border: 5px solid white">
</div>
<div class="desc">
  <div style="border-bottom: 2px dotted green">
<h1 class="annh">Chochopie Cake</h1>
<p style="text-align: center; font-size:15px; margin:15px">
  ...
  <div>
    <?php
    $_SESSION['cakeName']="Chochopie Cake";
    $_SESSION['price']="675.00";
    $_SESSION['imgcake']="bdcake7.jpg";
    $_SESSION['type']="cake";

...
<div class="img-zoom-container">
  <img id="myimage" src="scake10.jpg" width="300" height="300" style="border: 5px solid white">
</div>
<div class="desc">
  <div style="border-bottom: 2px dotted green">
<h1 class="annh">Ice Chochlate Cake</h1>
<p style="text-align: center; font-size:15px; margin:15px">Ice Choclate Cake
  For all the Choclate lovers!! Dark Ice Chochlate chunks with a sophisticated design.</p>
  </div>
  <div>
     <p style="color: brown; font-style: italic; margin-top: 40px; margin-left: 20px;margin-right: 20px;margin-bottom:40px;font-size: 20px; text-align: left;">Price: Rs 845.00
  ...
  <div>
    <?php
    $_SESSION['cakeName']="Ice Chochlate Cake";
    $_SESSION['price']="845.00";
    $_SESSION['imgcake']="scake10.jpg";

...
<div class="img-zoom-container">
  <img id="myimage" src="cj2.jpg" width="300" height="250" style="border: 3px solid white">
 
</div>
<div class="desc">
  <div style="border-bottom: 2px dotted green">
<h1 class="annh">Fruit Cake</h1>
  </div>
  <div>
  ...
  <div>
    <?php
    $_SESSION['cakeName']="Fruit Jar";
    $_SESSION['price']="675.00";
    $_SESSION['imgcake']="cj2.jpg";
    $_SESSION['type']="cake";

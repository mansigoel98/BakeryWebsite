...
<div class="img-zoom-container">
  <img id="myimage" src="scake3.jpg" width="300px" height="300px" style="border: 5px solid white">
</div>
<div class="desc">
  <div style="border-bottom: 2px dotted green">
<h1 class="annh">Strawberry Cake</h1>
<p style="text-align: center; font-size:15px; margin:15px">
  For all the Strawberry lovers!! Strawberry chunks with a sophisticated design.</p>
  </div>
  <div>
  ...
  <div>
    <?php
    $_SESSION['cakeName']="Strawberry Cake";
    $_SESSION['price']="675.00";
    $_SESSION['imgcake']="scake3.jpg";
    $_SESSION['type']="cake";

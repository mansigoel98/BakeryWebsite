...
<div class="img-zoom-container">
  <img id="myimage" src="scake4.jpg" width="300px" height="300px" style="border: 5px solid white">
</div>
<div class="desc">
  <div style="border-bottom: 2px dotted green">
<h1 class="annh">Vanilla Chochlate Cake</h1>
<p style="text-align: center; font-size:15px; margin:15px">Vanilla Chochlate 
  For all the Choclate lovers!! Vanilla Chochlate chunks with a sophisticated design.</p>
  </div>
  <div>
  ...
  <div>
    <?php
    $_SESSION['cakeName']="Vanilla Chochlate Cake";
    $_SESSION['price']="575.00";
    $_SESSION['imgcake']="scake4.jpg";
    $_SESSION['type']="cake";

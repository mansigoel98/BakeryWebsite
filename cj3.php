...
<div class="img-zoom-container">
  <img id="myimage" src="cj3.jpg" width="300" height="250" style="border: 3px solid white">
 
</div>
<div class="desc">
  <div style="border-bottom: 2px dotted green">
<h1 class="annh"> Chochlate Cake</h1>
  </div>
  <div>
     <p style="color: brown; font-style: italic; margin-top: 40px; margin-left: 20px;margin-right: 20px;margin-bottom:40px;font-size: 20px; text-align: left;">Price: Rs 575.00
  ...
  <div>
    <?php
    $_SESSION['cakeName']=" Chochlate Jar";
    $_SESSION['price']="575.00";
    $_SESSION['imgcake']="cj3.jpg";
    $_SESSION['type']="cake";

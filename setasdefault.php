...
<?php
         if(isset($_POST['def'])){
           ...
           if($con)
               {
                  mysqli_select_db($con,'bakery');
                  $q = "select * from address where addid = $addid";
                  $result = mysqli_query($con,$q);
                  $num=mysqli_num_rows($result);
              ...
              $q= "delete from defadd where username = '$username'";
              mysqli_query($con,$q);
              $q= "delete from secadd where username = '$username'";
              mysqli_query($con,$q);

              $q = "insert into defadd (addid,username,name,mobile,street,city,state,country,pin) values ($addid,'$username','$name','$mobile','$street','$city','$state','$country','$pin')";
              mysqli_query($con,$q);

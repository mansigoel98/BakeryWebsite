...
<div class="img-zoom-container">
  <img id="myimage" src="scake6.jpg" width="300" height="300" style="border: 5px solid white">
</div>
<div class="desc">
  <div style="border-bottom: 2px dotted green">
<h1 class="annh">Rose Cake</h1>
<p style="text-align: center; font-size:15px; margin:15px">Rose Cake
  For all the Rose lovers!! We have a Rose cake with a sophisticated design.</p>
  </div>
  <div>
  ...
  <div>
    <?php
    $_SESSION['cakeName']="Rose Cake";
    $_SESSION['price']="545.00";
    $_SESSION['imgcake']="scake6.jpg";
    $_SESSION['type']="cake";

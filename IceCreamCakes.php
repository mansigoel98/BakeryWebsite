...
<div id="myBtnContainer">
    <h1 class="annh"> Ice Cream Cakes</h1>
  ...
  <div class="row1">
    <div class="column nature">
      <div class="content">
        <a><img src="ic1.jpg" alt="bdcake" class="imgann" data-toggle="tooltip" title= "Click - Add to cart"></a>
        <h4>Mountains</h4>
    ...
    <div class="column nature">
      <div class="content">
        <a><img src="ic2.jpg" alt="bdcake" class="imgann" data-toggle="tooltip" title= "Click - Add to cart"></a>
        <h4>Lights</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
    <div class="column nature">
      <div class="content">
        <a><img src="ic3.jpg" alt="bdcake" class="imgann" data-toggle="tooltip" title= "Click - Add to cart"></a>
        <h4>Forest</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
    ...
    <div class="column cars">
      <div class="content">
        <a><img src="ic4.jpg" alt="bdcake" class="imgann" data-toggle="tooltip" title= "Click - Add to cart"></a>
        <h4>Retro</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
    <div class="column cars">
      <div class="content">
        <a><img src="ic5.jpg" alt="bdcake" class="imgann" data-toggle="tooltip" title= "Click - Add to cart"></a>
        <h4>Fast</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
    <div class="column cars">
      <div class="content">
        <a><img src="ic6.jpg" alt="bdcake" class="imgann" data-toggle="tooltip" title= "Click - Add to cart"></a>
        <h4>Classic</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
    ...
    <div class="column people">
      <div class="content">
        <a><img src="ic7.jpg" alt="bdcake" class="imgann" data-toggle="tooltip" title= "Click - Add to cart"></a>
        <h4>Girl</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
    <div class="column people">
      <div class="content">
        <a><img src="ic8.jpg" alt="bdcake" class="imgann" data-toggle="tooltip" title= "Click - Add to cart"></a>
        <h4>Man</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
    <div class="column people">
      <div class="content">
        <a><img src="ic9.jpg" alt="bdcake" class="imgann" data-toggle="tooltip" title= "Click - Add to cart"></a>
        <h4>Woman</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>

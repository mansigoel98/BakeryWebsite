...
<div class="catdiv">
  <?php
echo "<h2 style='text-align: center; color:brown ; font-style:italic ;margin: 10px;'>$username</h2>";
?>
</div>

<div class="catdiv">
<a href="myAccount.php" style="text-decoration: none"><h6 class="as">Account Dasboard</h6></a>
</div>
<div class="catdiv">
<a href="myaddress.php" style="text-decoration: none"><h6 class="as">Address Book</h6></a>
</div>
<div class="catdiv">
<a href="myWishlist.php" style="text-decoration: none"><h6 class="as">My Wishlist</h6></a>
</div>
<div class="catdiv">
<a href="viewCart.php" style="text-decoration: none"><h6 class="as">View Cart</h6></a>
</div>
</div>
...
<div class="catdiv">
<a href="cakes.php"  style="text-decoration: none"><h6 class="as">Cakes</h6></a>
<a href="Birthdaycake.php" style="text-decoration: none"><p class="as">Birthday Cakes</p></a>
<a href="AnniversaryCake.php" style="text-decoration:none"><p class="as"> Anniversary Cakes</p></a>
<a href="Customisedcake.php" style="text-decoration: none"><p class="as">Customised Cakes</p></a>
<a href="FlowerCake.php" style="text-decoration: none"><p class="as">Flower Cake</p></a>
<a href="IceCreamCakes.php" style="text-decoration: none"><p class="as">Ice Cream Cakes</p></a>
</div>
<div class="catdiv">
<a href="cookies.php" style="text-decoration: none"><h6 class="as">Cookies</h6></a>
</div>
<div class="catdiv">
<a href="cakesinJar.php" style="text-decoration: none"><h6 class="as">Cakes In Jar</h6></a>
</div>
<div class="catdiv">
<a href="LuxaryChoclate.php" style="text-decoration: none"><h6 class="as">Luxuary Chochlate</h6></a>
</div>
</div>
</section>
...
{
mysqli_select_db($con,'bakery');
$q = "insert into customer (username,email,phone,password) values ('$username','$email','$phone','$password')";
mysqli_query($con,$q);
}
...
<section class="div2">
    <h1 class="annh">My Dashboard </h1>
    <hr style="border-width: 2px">
    <h3 style="margin-left:50px"> <?php echo "Hello $username! " ?></h3>
    <p style="margin-left:50px">From your My Account Dashboard you have the ability to view a snapshot of 
    your recent account activity and update your account information. Select a link below to view or edit
     information.From your My Account Dashboard you have the ability to view a snapshot of 
    your recent account activity and update your account information. Select a link below to view or edit
     information.
    </p>
    <h4 class="annh1">Contact Information</h4>
    <h6 class="annh2">Username- &nbsp; <?php echo "$username" ?></h6>
    <h6 class="annh2">Email Id - <?php echo " $email" ?> </h6>
    <h6 class="annh2">Phone No - <?php  echo " $phone" ?></h6>
    <a href="editDetails.php"><h6 class="annh3">Edit</h6></a>
<br>
<br>
    <div>
        <div>
   <img src="reward_icon.jpg" alt="gift" style ="margin-left:330px ; float:left;"><h1 class="annh4">Reward Information</h1>
   <div>
   <h6 class="annh2">Your Reward Points: 1,100 points = ₹11.00</h6>
   <h6 class="annh2"> Points/Currency Exchange Rate: 1 points = ₹0.00</h6>

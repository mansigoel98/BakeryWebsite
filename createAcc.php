...
.inputs{
  ...
  background:white;
       ...
       <body>
        ...
        <div >
            <h1 class="annh">Create New Account</h1>
          
            <form class="bg-img" name="signUp" action=" myAcc.php" onsubmit="return validateForm()" method="post">
              <br>
             <h3 style="text-align:center">Enter Your Details</h3>
             <input type="text" placeholder="Enter UserName*" name="username" id="name" class="inputs" required>
            <input type="text" placeholder="Enter Email*" name="email" id="semail" class="inputs" required>
          
            <input type="number" placeholder="Enter Phone Number*" name="phone" id="snumber" class="inputs" required>
            <input type="password" placeholder="Enter Password*" name="psw" id="spass" class= "inputs" required>
            <input type="password" placeholder="Confirm Password*" name="cpsw" id="scpass" class= "inputs" required>
            <p  name ="cnf" style="color:pink">Passwords are not matching </p>
              <button type="submit" class="btn" id="onsubmit">SignUp</button>
            </form>
          </div>

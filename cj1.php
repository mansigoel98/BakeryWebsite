...
<div class="img-zoom-container">
  <img id="myimage" src="cj1.jpg" width="300" height="250" style="border: 3px solid white">
 
</div>
<div class="desc">
  <div style="border-bottom: 2px dotted green">
<h1 class="annh">Red Velvet Jar</h1>
  </div>
  <div>
  ...
  <div>
    <?php
    $_SESSION['cakeName']="Red Velvet Jar";
    $_SESSION['price']="945.00";
    $_SESSION['imgcake']="cj1.jpg";
    $_SESSION['type']="cake";

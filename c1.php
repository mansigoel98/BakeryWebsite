...
<div class="img-zoom-container">
  <img id="myimage" src="scake1.jpg" width="300" height="250" style="border: 3px solid white">
  <div id="myresult" class="img-zoom-result"></div>
</div>
<div class="desc">
  <div style="border-bottom: 2px dotted green">
<h1 class="annh">Strawberry Chochlate Cake</h1>
<p style="text-align: center; font-size:15px; margin:15px">Reg_Pineapple
  For all the pineapple lovers!! Fresh Pineapple chunks with a sophisticated design.</p>
  </div>
  <div>

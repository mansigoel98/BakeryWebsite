...
<div class="img-zoom-container">
  <img id="myimage" src="cj8.jpg" width="300" height="250" style="border: 3px solid white">
 
</div>
<div class="desc">
  <div style="border-bottom: 2px dotted green">
<h1 class="annh">Dark Magic Cake Jar</h1>
  </div>
  <div>
  ...
  <div>
    <?php
    $_SESSION['cakeName']="Dark Magic Cake Jar";
    $_SESSION['price']="745.00";
    $_SESSION['imgcake']="cj8.jpg";
    $_SESSION['type']="cake";

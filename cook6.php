...
<div class="img-zoom-container">
  <img id="myimage" src="cook6.jpg" width="300" height="300" style="border: 5px solid white">
</div>
<div class="desc">
  <div style="border-bottom: 2px dotted green">
<h1 class="annh">Gems Cookies</h1>
...
Fortune cookies are a good idea. If the message is positive, it can make your day a little better.</p>
  ...
  <div>
     <p style="color: brown; font-style: italic; margin-top: 40px; margin-left: 20px;margin-right: 20px;margin-bottom:40px;font-size: 20px; text-align: left;">Price: Rs 545.00/half kg
  ...
  <form name="entry" onsubmit="return validate()" action="cart.php" method="POST">
    <?php
    $_SESSION['cakeName']="Gems Cookies";
    $_SESSION['price']="545.00";
    $_SESSION['imgcake']="cook6.jpg";

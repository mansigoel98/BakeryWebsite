...
<div class="img-zoom-container">
  <img id="myimage" src="scake5.jpg" width="300" height="300" style="border: 5px solid white">
</div>
<div class="desc">
  <div style="border-bottom: 2px dotted green">
<h1 class="annh">Flower Cake</h1>
<p style="text-align: center; font-size:15px; margin:15px">Beautiful Flower cake
  For all the Flower lovers!! All flavours chunks with a sophisticated design.</p>
  </div>
  <div>
  ...
  <div>
    <?php
    $_SESSION['cakeName']="Flower Cake";
    $_SESSION['price']="875.00";
    $_SESSION['imgcake']="scake5.jpg";
    $_SESSION['type']="cake";

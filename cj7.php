...
<div class="img-zoom-container">
  <img id="myimage" src="cj7.jpg" width="300" height="250" style="border: 3px solid white">
 
</div>
<div class="desc">
  <div style="border-bottom: 2px dotted green">
<h1 class="annh">Dark Chochlate Cake Jar</h1>
  </div>
  <div>
  ...
  <div>
    <?php
    $_SESSION['cakeName']="Dark Chochlate Cake Jar";
    $_SESSION['price']="1075.00";
    $_SESSION['imgcake']="cj7.jpg";
    $_SESSION['type']="cake";

...
<div id="myBtnContainer">
  ...
  <div class="row1">
    <div class="column nature">
      <div class="content">
        <a><img src="bdcake1.jpg" alt="bdcake" class="imgann" data-toggle="tooltip" title= "Click - Add to cart"></a>
        <h4>Mountains</h4>
    ...
    <div class="column nature">
      <div class="content">
        <a><img src="bdcake2.jpg" alt="bdcake" class="imgann" data-toggle="tooltip" title= "Click - Add to cart"></a>
        <h4>Lights</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
    <div class="column nature">
      <div class="content">
        <a><img src="bdcake3.jpg" alt="bdcake" class="imgann" data-toggle="tooltip" title= "Click - Add to cart"></a>
        <h4>Forest</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
    ...
    <div class="column cars">
      <div class="content">
        <a><img src="bdcake4.jpg" alt="bdcake" class="imgann" data-toggle="tooltip" title= "Click - Add to cart"></a>
        <h4>Retro</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
    <div class="column cars">
      <div class="content">
        <a><img src="bdcake5.jpg" alt="bdcake" class="imgann" data-toggle="tooltip" title= "Click - Add to cart"></a>
        <h4>Fast</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
    <div class="column cars">
      <div class="content">
        <a><img src="bdcake6.jpg" alt="bdcake" class="imgann" data-toggle="tooltip" title= "Click - Add to cart"></a>
        <h4>Classic</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
    ...
    <div class="column people">
      <div class="content">
        <a><img src="bdcake7.jpg" alt="bdcake" class="imgann" data-toggle="tooltip" title= "Click - Add to cart"></a>
        <h4>Girl</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
    <div class="column people">
      <div class="content">
        <a><img src="bdcake8.jpg" alt="bdcake" class="imgann" data-toggle="tooltip" title= "Click - Add to cart"></a>
        <h4>Man</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
    <div class="column people">
      <div class="content">
        <a><img src="bdcake9.jpg" alt="bdcake" class="imgann" data-toggle="tooltip" title= "Click - Add to cart"></a>
        <h4>Woman</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>

...
<div class="img-zoom-container">
  <img id="myimage" src="scake8.jpg" width="300" height="300" style="border: 5px solid white">
</div>
<div class="desc">
  <div style="border-bottom: 2px dotted green">
<h1 class="annh">Dark Magic Cake</h1>
<p style="text-align: center; font-size:15px; margin:15px">Dark Magic Cake
  For all the Choclate lovers!! Dark Chochlate chunks with a sophisticated design.</p>
  </div>
  <div>
     <p style="color: brown; font-style: italic; margin-top: 40px; margin-left: 20px;margin-right: 20px;margin-bottom:40px;font-size: 20px; text-align: left;">Price: Rs 745.00
  ...
  <div>
    <?php
    $_SESSION['cakeName']="Dark Magic Cake";
    $_SESSION['price']="745.00";
    $_SESSION['imgcake']="scake8.jpg";
    $_SESSION['type']="cake";

...
<div id="myBtnContainer">
  ...
  <div class="row">
    <div class="column nature">
      <div class="content">
        <img src="bdcake1.jpg" alt="bdcake" style="width:100%">
        <h4>Mountains</h4>
    ...
    <div class="column nature">
      <div class="content">
      <img src="bdcake2.jpg" alt="bdcake" style="width:100%">
        <h4>Lights</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
    <div class="column nature">
      <div class="content">
      <img src="bdcake3.jpg" alt="bdcake" style="width:100%">
        <h4>Forest</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
    ...
    <div class="column cars">
      <div class="content">
        <img src="annicake1.jpg" alt="annicake" style="width:100%">
        <h4>Retro</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
    <div class="column cars">
      <div class="content">
      <img src="annicake2.jpg" alt="annicake" style="width:100%">
        <h4>Fast</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
    <div class="column cars">
      <div class="content">
      <img src="annicake3.jpg" alt="annicake" style="width:100%">
        <h4>Classic</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
    ...
    <div class="column people">
      <div class="content">
        <img src="cuscake1.jpg" alt="Cuscake" style="width:100%">
        <h4>Girl</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
    <div class="column people">
      <div class="content">
      <img src="cuscake2.jpg" alt="Cuscake" style="width:100%">
        <h4>Man</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
    <div class="column people">
      <div class="content">
      <img src="cuscake3.jpg" alt="Cuscake" style="width:100%">
        <h4>Woman</h4>
        <p>Lorem ipsum dolor..</p>
      </div>
    </div>
